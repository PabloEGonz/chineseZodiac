...
// Takes the input year and stores it in the variable 
    ...
    if(ox.includes(zodiac) ===  true){
        ...
        document.getElementById("oxlink").innerHTML = "click here to know more"
    ...
    if(tiger.includes(zodiac) ===  true){
        ...
        document.getElementById("tigerlink").innerHTML = "click here to know more"
    }
    if(rabbit.includes(zodiac) ===  true){
        ...
        document.getElementById("rabbitlink").innerHTML = "click here to know more"
    }
    if(dragon.includes(zodiac) ===  true){
        ...
        document.getElementById("dragonlink").innerHTML = "click here to know more"
    }
    if(snake.includes(zodiac) ===  true){
        ...
        document.getElementById("snakelink").innerHTML = "click here to know more"
    }
    if(horse.includes(zodiac) ===  true){
        ...
        document.getElementById("horselink").innerHTML = "click here to know more"
    }
    if(goat.includes(zodiac) ===  true){
        ...
        document.getElementById("goatlink").innerHTML = "click here to know more"
    }
    if(monkey.includes(zodiac) ===  true){
        ...
        document.getElementById("monkeylink").innerHTML = "click here to know more"
    }
    if(rooster.includes(zodiac) ===  true){
        ...
        document.getElementById("roosterlink").innerHTML = "click here to know more"
    }
    if(dog.includes(zodiac) ===  true){
        ...
        document.getElementById("doglink").innerHTML = "click here to know more"
    }
    if(pig.includes(zodiac) ===  true){
        ...
        document.getElementById("piglink").innerHTML = "click here to know more"
    }
